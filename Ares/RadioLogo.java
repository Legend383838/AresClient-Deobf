...
public class RadioLogo {
   ...
   public static void drawRotatingScaledLogo(float var0, float var1, int var2) {
      ...
      double var3 = 0.2D;
      double var5 = Math.cos((double)System.currentTimeMillis() / 120.0D * 0.2D % 360.0D) * 90.0D + 90.0D;
      GL11.glRotatef((float)var5, 0.0F, 0.0F, 0.5F);
      drawTexture(new ResourceLocation("radio/radio" + Radio + ".png"), (float)(-var2) / 2.0F, (float)(-var2) / 2.0F, (float)var2, (float)var2);
      GL11.glPopMatrix();
   }
}
